...
ExpressionOpAssignmentDiv::ExpressionOpAssignmentDiv() {
    type = EXP_OP_ASSIGNMENT_DIV;
}

void ExpressionOpAssignmentDiv::action(const CompilerArgs &args) const {
...
std::string ExpressionOpAssignmentDiv::toString() const {
    return "/=";
}

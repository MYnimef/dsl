...
ExpressionOpAssignmentMult::ExpressionOpAssignmentMult() {
    type = EXP_OP_ASSIGNMENT_MULT;
}

void ExpressionOpAssignmentMult::action(const CompilerArgs &args) const {
...
std::string ExpressionOpAssignmentMult::toString() const {
    return "*=";
}

...
ExpressionOpAssignmentSub::ExpressionOpAssignmentSub() {
    type = EXP_OP_ASSIGNMENT_SUB;
}

void ExpressionOpAssignmentSub::action(const CompilerArgs &args) const {
...
std::string ExpressionOpAssignmentSub::toString() const {
    return "-=";
}
